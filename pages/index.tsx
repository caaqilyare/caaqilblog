        ...
        <div className='flex justify-between items-center bg-yellow-400 border-y border-black py-10 lg:py-0'>
          <div className='px-10 space-y-5'> 
              <h1 className='text-6xl max-w-xl font-serif'>
                <span className='underline decoration-black decoration-4'>Medium</span> {""} waa meesha wax lagu qoro , wax lagu aqriyo , laguna xiriiro
              </h1>
              <h2>Project gaan waxaan ku sameeyay Next js front end  iyo Sanity back end Waana simple website 
              </h2>
          </div>
